    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional', models.CharField(blank=True,
                                                default=None, max_length=512, null=True)),
                ('balance', models.DecimalField(blank=True,
                                                decimal_places=2, default=None, max_digits=19, null=True)),
                ('not_now', models.BooleanField(default=False)),
                ('note', models.CharField(blank=True,
                                          default=None, max_length=64, null=True)),
                ('bank_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                   related_name='banktransactions', to='bank_accounts.BankAccount')),
                ('tags', models.ManyToManyField(blank=True, default=None,
                                                related_name='banktransactions', to='ledgers.Tag')),
            ],
            options={
                'ordering': ['date'],
            },
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(
                on_delete=django.db.models.deletion.CASCADE, to='bank_reconciliations.BankTransaction'),
        ),
        migrations.AddField(
            model_name='bankentry',
            name='transaction',
