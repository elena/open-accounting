...
class TestModelEntityCreateObject(TestCase):
    ...
    def test_create_object_single_passes(self):
        ...
        test_input = "creditor\tdate\tinvoice_number\treference\tvalue\tgst_total\torder_number\t[15-0608]\t[15-0151]\t[15-0155]\t[15-0301]\t[15-0305]\r\nBIDVES\t02-Jun-2017\tI38731476\tO37696095\t$485.27\t$0.65\tguild house\t6.5\t478.12\t\t\t"  # NOQAfr
        test_create_object = Entry.create_objects(
            Entry.dump_to_kwargs(test_input,
                                 user=self.user,
...
class TestModelEntityDumpToKwargs(TestCase):
...
class TestModelEntityCheckRequired(TestCase):
