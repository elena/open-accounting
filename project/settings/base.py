...
Intended as an app that just works. If you want to use it as a reusable, go at it,
intentionally starting from the other way around rather than going through the
dependency hell of retrofitting a project for something whose most common use-case will
be stand-alone.
